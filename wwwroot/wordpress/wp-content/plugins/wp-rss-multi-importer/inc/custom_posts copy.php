   ...
   function rssmi_show_feed_item_custom_columns( $column, $post_id ) {
       ...
       switch ( $column ) {             
           ...
           case "publishdate":
               ...
               $publishdate = date( 'Y-m-d H:i:s', get_post_meta( get_the_ID(), 'rssmi_item_date', true ) ) ;          
               echo $publishdate;
               break;   
   ...
   function rssmi_show_meta_box() {
	...
	function rssmi_preview_meta_box() {
       ...
       if( ! empty( $feed_url ) ) {         
           ...
           else echo "<strong>Invalid feed URL</strong> - Double check the feed source URL setting above or <a href=\"http://www.allenweiss.com/faqs/im-told-the-feed-isnt-valid-or-working/\" target=\"_blank\">go here to learn more about what might be wrong</a>.";
       }
