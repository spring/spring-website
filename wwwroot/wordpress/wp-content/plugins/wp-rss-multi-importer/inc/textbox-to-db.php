...
foreach($URL_arr as $url_a){
	...
	<div class="inside">
		...
		<form action="" method="post">
		  ...
		  <div>Enter one Feed Name per line, comma delimited as follows (the plugin category and Blog User ID are optional):</div><br>
	...
	<br><br><p>If you need to get the plugin category ID number, simply click on the Categories Tab.  To get the Blog User ID, <a href="http://www.allenweiss.com/faqs/finding-the-blog-user-id/" target="_blank">use this link to find out how</a>.</p>
